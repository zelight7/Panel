...
// in panel/test/helpers/test_helpers.dart.
...
import 'package:panel/services/panel_base_service.dart' as _i8;
import 'package:panel/sliding_up_panel/panel.dart' as _i2;
...
class _FakePanelController_0 extends _i1.SmartFake
    implements _i2.PanelController {
  _FakePanelController_0(
    Object parent,
...
/// A class which mocks [PanelBaseService].
///
/// See the documentation for Mockito's code generation for more information.
class MockPanelBaseService extends _i1.Mock implements _i8.PanelBaseService {
  @override
  _i2.PanelController get controller => (super.noSuchMethod(
        Invocation.getter(#controller),
        returnValue: _FakePanelController_0(
          this,
          Invocation.getter(#controller),
        ),
        returnValueForMissingStub: _FakePanelController_0(
          this,
          Invocation.getter(#controller),
        ),
      ) as _i2.PanelController);

  @override
  set controller(_i2.PanelController? _controller) => super.noSuchMethod(
        Invocation.setter(
          #controller,
          _controller,
        ),
  ...
  @override
  _i3.ScrollController get gameMenuSc => (super.noSuchMethod(
        Invocation.getter(#gameMenuSc),
  ...
  @override
  set gameMenuSc(_i3.ScrollController? _gameMenuSc) => super.noSuchMethod(
        Invocation.setter(
          #gameMenuSc,
          _gameMenuSc,
        ),
  ...
  @override
  _i3.ScrollController get personalCenterSc => (super.noSuchMethod(
        Invocation.getter(#personalCenterSc),
        returnValue: _FakeScrollController_1(
          this,
          Invocation.getter(#personalCenterSc),
        ),
  ...
  @override
  set personalCenterSc(_i3.ScrollController? _personalCenterSc) =>
      super.noSuchMethod(
        Invocation.setter(
          #personalCenterSc,
          _personalCenterSc,
  ...
  @override
  set currentNavigatorContext(_i3.BuildContext? _currentNavigatorContext) =>
      super.noSuchMethod(
        Invocation.setter(
          #currentNavigatorContext,
          _currentNavigatorContext,
        ),
        returnValueForMissingStub: null,
      );

  @override
  bool get isDraggable => (super.noSuchMethod(
        Invocation.getter(#isDraggable),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);

  @override
  set isDraggable(bool? value) => super.noSuchMethod(
        Invocation.setter(
          #isDraggable,
          value,
        ),
  ...
  @override
  bool get isGuestLogin => (super.noSuchMethod(
        Invocation.getter(#isGuestLogin),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);

  @override
  set isGuestLogin(bool? value) => super.noSuchMethod(
        Invocation.setter(
          #isGuestLogin,
          value,
        ),
  ...
  @override
  void setPanelScToGameMenu() => super.noSuchMethod(
        Invocation.method(
          #setPanelScToGameMenu,
          [],
        ),
        returnValueForMissingStub: null,
      );
  ...
  @override
  void setPanelScToPersonalCenter() => super.noSuchMethod(
        Invocation.method(
          #setPanelScToPersonalCenter,
          [],
        ),
        returnValueForMissingStub: null,
      );
  ...
  @override
  void showCustomPopup(_i3.BuildContext? context) => super.noSuchMethod(
        Invocation.method(
          #showCustomPopup,
          [context],
        ),
